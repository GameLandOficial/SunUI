...
![versão](https://img.shields.io/badge/versão-5.3.0-blueviolet?style=for-the-badge)
...
| `Width` / `Height` | number | `720` / `500` | Tamanho da janela |
...
-- Asset ID ou URL, lista de até 12 salvos (SunUI_Backgrounds.json)
